...
public class PainelResultadoPig extends PainelResultado {

	// /////////////////////////////////////////////////////////////////////
	// INICIALIZACAO DO PAINEL RESULTADOPIG

	public PainelResultadoPig() {
		config(ImageTools.JOGOPIG_BACKGROUND);
	}
	...
	public void setResultado(int acertos, int erros) {
		...
		txtResultado.setText("A porcentagem de cestas corretas é de:");
