...
public class LabelPersonagemRabbit extends LabelPersonagem implements
		MouseMotionListener {
	...
	// ///////////////////////////////////////////////////////////////
	// INICIALIZACAO DO LABEL RABBIT

	public LabelPersonagemRabbit(int posicao) {		
		setSprite(ImageTools.RABBIT, 2);
		setSize(99, 250);
